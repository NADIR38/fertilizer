    ...
    public partial class BulkSupplierPaymentForm : Form
    {
        ...
        private void LoadSupplierSummaries(string searchText = "")
        {
            try
            {
                ...
                if (dgvSuppliers.Columns.Contains("TotalPaid"))
                {
                ...
                if (dgvSuppliers.Columns.Contains("PendingBillCount"))
                {
